...
//innerHTML은 보안상 취약하다고 알려져 있고, 따라서 insertAdjacenHTML 사용을 권장한다!!
...
// c.insertAdjacenHTML = "<h1>insert element to c</h1>"
// c.insertAdjacentHTML('afterend', '<div id="c">insert element to c</div>');
// const d = '<h1>insert element to b</h1>'
// c.insertAdjacentHTML('afterend',  );
// c.insertAdjacentHTML('afterend', d );
...
// const attr = btns.getAttribute('id');
// console.log(attr);
