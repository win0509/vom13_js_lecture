...
// 문자는 홀따옴표와 겹따옴표 어 떤 것을 사용해도 되나, 따옴표 안에 다른 따옴표가 들어간다면 홀과 겹을 다르게 사용해야 한다.
...
// if(age > 17){
//  document.write('술 먹을 수 있음');
// }else{
//  document.write('술 먹을 수 없음');
// }

// 6. undefined
// undefined 는 원시값(Primitive Type)으로, 선언한 후에 값을 할당하지 않은 변수나 값이 주어지지 않은 인수에 자동으로 할당된다.
//undefined는 값이 없으므로 특정 기능이 작동하지 않는 결과 가져올 수 있다.하지만 오류는 아니어서 런타임은 진행된다. 
